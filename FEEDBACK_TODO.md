...
- [ ] **PERSONAL POND THEMES** (Scott's memories, 2026-07-03, "all of it, tastefully"): Buker=boat launch (dawn) · Woodbury=big water of the Tacoma chain (turtle log moves here) · Purgatory=shallow/weedy/rarely reached (keep bog+tree) · Sand=CAMP (pontoon hero, bonfire+grill bank, barred owls, Sadie visits more — she jumps off docks here) · Pleasant=best fishing (anchored skiff hero, minnows richer) · Emerald=Colorado alpine for his wife (pines, crisp light) · Cochichewick=birding + Lizzie the beagle + the Weir Hill red-tail (Rusty cameos more, Lizzie on the bank).
