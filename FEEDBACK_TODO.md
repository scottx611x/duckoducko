...
- [ ] ⏳ AWAITING SCOTT: (1) fps pill numbers from his phone — menu vs mid-run vs boss; (2) phone model + browser (iPhone Safari vs Android Chrome changes the whole diagnosis). NO more blind perf theories — next fix must chase the numbers.
