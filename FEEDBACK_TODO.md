...
- [ ] ⏳ AWAITING SCOTT on v1.21.45: play until it feels laggy with SHOW FPS on → SETTINGS → VIEW APP LOGS → screenshot the [hitch] lines + the new gpu: footer. The hitch lines name the culprit; then we fix THAT.
