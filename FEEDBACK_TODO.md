...
- [ ] **THE BOREDOM, VERDICT ON v1.23.0: moods did NOT cure it.** Moods varied the log *pattern* but the duck still has one verb between set-pieces. This needs a deeper swing — direction being decided with Scott (new core verb / pressure layer / river redesign).
