...
- [ ] **Death screen crowding** (Scott, 2026-07-03) — too much stacked (eulogy/killer/next-unlock/big-day/again?/relics); tighten hierarchy.
- [ ] **Slowdowns when lots happening** — particle/effect pileups in heavy moments; cap + trim.
- [ ] **CONSULT: less frequent but more meaningful per-biome art** (also a perf win) — awaiting Scott's direction.
